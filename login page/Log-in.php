...
<body>
          ...
          <div class="card card-registration my-4">
            <div class="row g-0">
              <div class="col-xl-6 d-none d-xl-block">
                <img src="./Img/pexels-mark-mccammon-1080696.jpg" alt="Sample photo" class="img-fluid" style="border-top-left-radius: .25rem; border-bottom-left-radius: .25rem;" />
              </div>
              <div class="col-xl-6">
  ...
  if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    try {
      ...
      $stmt2 = $conn->query("SELECT * FROM `member` WHERE  `MembrePasse`='$password'");
      ...
      } elseif (!$passLigne && !password_verify($password, $emailLigne["MembrePasse"])) {
